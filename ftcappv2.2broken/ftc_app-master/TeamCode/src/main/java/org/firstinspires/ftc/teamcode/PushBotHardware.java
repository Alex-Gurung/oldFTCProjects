...
public class PushBotHardware extends OpMode
{
    ...
    private DcMotorController v_dc_motor_controller_arm;
...

    {
        ...
        v_dc_motor_controller_arm
                = hardwareMap.dcMotorController.get("arm_controller");
    ...
    // Performs any actions that are necessary when the OpMode is enabled.
    //
    // The system calls this member once when the OpMode is enabX   led.
    //--------
