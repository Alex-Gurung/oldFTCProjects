 ...
 */
public class rnired extends BotHardwareArmAuto{
...
//setup
        ...
        telemetry.addData("LEFT IF U DUN KNOW WHAT UR DOING THEN STAWP CUZ THIS ISNT DUN YET AND TESTED YET!!!!!", "");
        waitForStart();
        setup();
...
//turns 45 degrees
        ...
        /*something:  while (opModeIsActive()) {
            ...
            if ((heading>300 && heading< 317)||(heading2>300&&heading<317)){
                fwd(0, 0, 0, 0);
                break something;
            }
            else {
...
//pushes blocks out of way
        ...
        thething:        while (opModeIsActive()) {
            ...
            telemetry.addData("gyro1: ", heading);
            telemetry.addData("gyro2: ", heading2);
            if (((heading<100)&&(heading>43))||((heading2<100)&&(heading2>43)))
            {
                fwd(0, 0, 0, 0);
                break thething;
            }
